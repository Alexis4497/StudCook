...
final class Version20221201121346 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE marques CHANGE lien_image_marque lien_image_marque VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE marques CHANGE nom_marque nom_marque VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE lien_image_marque lien_image_marque VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
