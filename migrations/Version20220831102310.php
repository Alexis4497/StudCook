 ...
 */
final class Version20220831102310 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recettes ADD filename VARCHAR(255) NOT NULL, CHANGE image_recette image_recette VARCHAR(255) NOT NULL');
    }
